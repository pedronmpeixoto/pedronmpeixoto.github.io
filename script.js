...
const translations = {
  pt: {
    ...
    case_3_p: "Desenvolvimento de Agentes de Inteligência Artificial para geração e validação automatizada de minutas contratuais padronizadas, reduzindo drasticamente custos de assinaturas com provedores de LLMs.",
  ...
  en: {
    ...
    case_3_p: "Development of Artificial Intelligence Agents for automated generation and validation of standardized contract drafts, significantly reducing LLM provider subscription costs.",
